...
if (production && (!secret || secret.length < 32)) throw new Error('Set JWT_SECRET to at least 32 characters');
...
export const settings = {
  ...
  accountsPath: process.env.MOODLE_ACCOUNTS_FILE || resolve(import.meta.dirname, '../../../config/accounts.json'),
};
